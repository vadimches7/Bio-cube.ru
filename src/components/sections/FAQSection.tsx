  ...
  service: [
    {
      ...
      answer: "Диагностический выезд — от 2 500 ₽. Разовый сервисный визит считается по времени: “выезд + 1-й час” + “каждый следующий час”. Абонемент (еженедельный визит) — от 7 000 ₽/мес. Итоговую стоимость подтверждаем перед началом работ; цены указаны с учётом НДС и не являются публичной офертой (п. 2 ст. 437 ГК РФ).",
    },
    {
